...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6"> 
                    <h4>Điểm danh sáng lớp : <strong>{{$lophoc->ma_lop_hoc}}</strong> - Ngày : <strong>{{date("d-m-Y",strtotime($ngay))}}</strong></h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item active"> Điểm danh sáng</li>
                    </ol>
                </div> 
                ...
                <div class="card card-tabs">
                        <div class="card-body">
                            <form action="{{route('admin.lophoc.monhoc.diemdanh.post')}}"  role="form" method="post">
                                ...
                                <input type="hidden" name="ca_hoc" value="0">
