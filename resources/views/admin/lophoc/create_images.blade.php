        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-lg-12 mb-4">
                    <h1>Cập nhật ảnh quá trình lớp : {{$lophoc->ma_lop_hoc}}</h1>
                </div>
                <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-md-12 col-12">
                <div class="card card-success card-outline">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('admin.lophoc.post.images',$lophoc->id)}}"  role="form" method="post" enctype="multipart/form-data">
                        @csrf    
                        <div class="card-body">
                            <div class="form-row">
